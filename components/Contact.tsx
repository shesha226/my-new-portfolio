...
function Contact() {
  ...
  const workdata = theme === 'dark' ? 'text-gray-300' : 'text-gray-600';
  ...
  return (
    ...
    >
      ...
      <motion.form
        ...
        onSubmit={send} // ✅ use onSubmit, not action
      >
        <motion.div className="grid grid-cols-1 gap-6 mt-10 mb-8 md:grid-cols-2">
          <motion.input
