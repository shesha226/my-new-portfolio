...
export const serviceData = [
  {
    ...
    description: 'Robust server-side applications & APIs for seamless functionality.',
    link: '',
  },
  {
    icon: assets.mobile_icon,
    title: 'Frontend Development',
    description: 'Responsive, interactive, and user-friendly web interfaces.',
    link: '',
  },
  {
    icon: assets.ui_icon,
    title: 'UI/UX Design',
    description: 'Intuitive and visually appealing designs for great user experience.',
    link: '',
  },
  {
